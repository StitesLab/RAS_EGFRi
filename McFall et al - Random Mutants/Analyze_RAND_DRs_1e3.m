...
save Sens_Rand_1e3.txt Sens_Rand -ASCII -double
save Sens_Rand2_1e3.txt Sens_Rand2 -ASCII -double

%figure(1005), semilogy(Sens_Rand','k.')
%figure(1006), semilogy(Sens_Rand2','k.')
